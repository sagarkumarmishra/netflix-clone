  ...
  return (
    <div>
      ...
      <Image
        ...
        layout="fill"
        className="-z-10 select-none opacity-100"
        objectFit="cover"
      />
      ...
      <header>
        ...
        />
        <Link href="/login">
          <button className="text- rounded bg-[#e50910] px-[14px] py-[4px] md:px-[17px] md:py-[7px]">
            Sign In
          </button>
        </Link>
      </header>
        ...
        <div className="flex min-h-screen flex-1 flex-col items-center justify-center">
          ...
          <div className="mt-2 flex md:mt-4">
            <input
              ...
              className="rounded-tl rounded-bl bg-white py-2 px-2 md:min-w-[450px] md:py-4 md:pl-2 md:pr-6"
            />

            <button className="flex !cursor-pointer items-center justify-center rounded-tr rounded-br bg-[#e50914] px-4 text-base md:px-8 md:text-2xl">
              Get Started
              <svg
